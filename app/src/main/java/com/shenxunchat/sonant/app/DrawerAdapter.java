...
//    public static final int ITEM_LAN = 7;
    ...
    public static final int ITEM_CURRENT_CHANNEL = 11;
    ...
    public DrawerAdapter(Context context, DrawerDataProvider provider) {
        ...
        add(new DrawerAdapter.DrawerItem(ITEM_CURRENT_CHANNEL, context.getString(R.string.drawer_current), R.drawable.ic_action_channels));
        ...
        add(new DrawerAdapter.DrawerItem(ITEM_FAVOURITES, context.getString(R.string.drawer_header_servers), R.drawable.ic_action_favourite_on));
