...
import com.shenxunchat.sonant.channel.AccessTokenFragment;
import com.shenxunchat.sonant.channel.ChannelFragment;
import com.shenxunchat.sonant.channel.ServerInfoFragment;
import com.shenxunchat.sonant.db.DatabaseCertificate;
import com.shenxunchat.sonant.db.DatabaseProvider;
import com.shenxunchat.sonant.db.MumlaDatabase;
import com.shenxunchat.sonant.db.MumlaSQLiteDatabase;
import com.shenxunchat.sonant.db.PublicServer;
import com.shenxunchat.sonant.preference.MumlaCertificateGenerateTask;
import com.shenxunchat.sonant.preference.SettingsActivity;
import com.shenxunchat.sonant.servers.FavouriteServerListFragment;
import com.shenxunchat.sonant.servers.PublicServerListFragment;
import com.shenxunchat.sonant.servers.ServerEditFragment;
import com.shenxunchat.sonant.service.IMumlaService;
import com.shenxunchat.sonant.service.MumlaService;
import com.shenxunchat.sonant.util.HumlaServiceFragment;
import com.shenxunchat.sonant.util.HumlaServiceProvider;
import com.shenxunchat.sonant.util.MumlaTrustStore;
...
public class MumlaActivity extends AppCompatActivity implements ListView.OnItemClickListener,
    ...
    protected void onNewIntent(Intent intent) {
        ...
        setIntent(intent);
        if (intent != null && intent.hasExtra(EXTRA_DRAWER_FRAGMENT) && mDrawerAdapter != null) {
            loadDrawerFragment(intent.getIntExtra(
    ...
    private void loadDrawerFragment(int fragmentId) {
        ...
        switch (fragmentId) {
            case DrawerAdapter.ITEM_SERVER:
                ...
                break;
            case DrawerAdapter.ITEM_CURRENT_CHANNEL:
                fragmentClass = ChannelFragment.class;
