...
package com.shenxunchat.sonant;
...
public class Settings {
    ...
    public static final Boolean DEFAULT_PTT_TOGGLE = true;
    ...
    public static final int DEFAULT_INPUT_QUALITY = 12000;
     ...
     * @see com.shenxunchat.sonant.db.DatabaseCertificate
     */
    public static final String PREF_CERT_ID = "certificateId";

    public static final String PREF_DEFAULT_USERNAME = "defaultUsername";
    public static final String DEFAULT_DEFAULT_USERNAME = "Sonant_User"; // funny var name
