...
package com.shenxunchat.sonant.channel.comment;
...
public abstract class AbstractCommentFragment extends DialogFragment {
     ...
     * This method is expected to set a callback that will call {@link com.shenxunchat.sonant.channel.comment.AbstractCommentFragment#loadComment(String comment)}.
